...
namespace RogueLineageRaces.Common.Races.Morvid
{
	public class Morvid : Race
	{
		...
		public override string RaceAbilityDescription1 => "The crows you were made from seem to have become fearful and want to stick closer together now. Instead of dispersing yourself into multiple crows";
		public override string RaceAbilityDescription2 => "and putting yourself back together, your crows will now shift around and move too fast for the enemy to hit you while also keeping your human form";
		public override string RaceAbilityDescription3 => "mostly active and avaliable for continued use. Immense boost to Movement during Duration. Acts as temporary invincibility to anything but (de)buffs.";
		public override string RaceAbilityDescription4 =>"----------------------------------------------------------------------------------------------------";
		public override string RaceAbilityDescription5 => "During your Flock cooldown, you can press the ability key again to gain a boost to your ground movement, causing you to accelerate much faster at a somewhat low cost of health. Unusable below 12% health. *Gives no effects during Crazed Flock.";
		...
		public override string RaceAggroDisplayText => "[c/34EB93:-120]";
