...
namespace RogueLineageRaces.Common.Races.Gaian
{
	public class Gaian : Race
	{
		...
		public override string RaceLore1 => "Gaians are a robot" + "\nrace oriented around" + "\nbeing tanky, but with" + "\na twist.";
		public override string RaceLore2 => "Their natural resistance to damage" + "\nand great quality of metal" + "\nmakes wearing defensive armor" + "\n less useful.";
		...
		public override string RaceEnvironmentOverlay2Icon => ($"RogueLineageRaces/Common/UI/RaceDisplay/Environment/GaianEnvironment");
		
		public override string RaceHealthDisplayText => "[c/FF4F64:-30%]";
		public override string RaceDamageReductionDisplayText => "[c/34EB93:+70%]";
		public override string RaceDefenseDisplayText => "[c/FF4F64:-60]";
		public override string RaceAbilityName => "Gaian Repair";
		...
		public override string RaceAbilityDescription2 => "Additionally, during repair you become inflicted with Cursed, causing you to temporarily be defenseless.";

		public override string RaceAdditionalNotesDescription1 => "- '-60 defense' means that your equipment/buffs will need to go past 60 total defense for you to actually start gaining defense.";
		public override string RaceAdditionalNotesDescription2 => "-Ichor either has a lacking effect on you or a heavy one depending on how far you are into the game.";
		...
		public override void ResetEffects(Player player)
		{
			...
			{
			    player.statLifeMax2 -= (player.statLifeMax2 / 10 * 3);
