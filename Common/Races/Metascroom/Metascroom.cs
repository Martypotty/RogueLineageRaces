...
namespace RogueLineageRaces.Common.Races.Metascroom
{
	public class Metascroom : Race
	{
		...
		public override string RaceHealthDisplayText => "[c/FF4F64:-55%]";
		public override string RaceDamageReductionDisplayText => "[c/34EB93:+47.5%]";
		...
		public override string RaceAdditionalNotesDescription1 => "- '-15 defense' means that your equipment/buffs will need to go past 15 total defense for you to actually start gaining defense.";
		...
		public override void ResetEffects(Player player)
		{
			...
			if (modPlayer.RaceStats)
			{
				...
				if (player.HasBuff(69)) // Don't drink Ichor! It's bad for your brain.. Wait.. What do you mean you don't have one?? A Metascroom?.. Oh.
				{
					player.statDefense += 10;
				}
			    player.statLifeMax2 -= (player.statLifeMax2 / 20 * 11);
				player.endurance += 0.475f;
