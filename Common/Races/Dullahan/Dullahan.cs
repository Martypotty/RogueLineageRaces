...
namespace RogueLineageRaces.Common.Races.Dullahan
{
	public class Dullahan : Race
	{
		...
		public override string RaceLore1 => "Dullahans are a race" + "\noriented around" + "\nfreak-like HP regen.";
		public override string RaceLore2 => "Their ability to regenerate faster" + "\nwithout a need to eat is effectively" + "\ntheir main ability." + "\nThey have a Knack for throwables.";
		...
		public override string RaceEnvironmentOverlay2Icon => ($"RogueLineageRaces/Common/UI/RaceDisplay/Environment/DullaEnvironment");
		...
		public override string RaceRegenerationDisplayText => "[c/34EB93:+8]";
		...
		public override void ModifyDrawInfo(Player player, Mod mod, ref PlayerDrawInfo drawInfo)
        {
            ...
            if (modPlayer.resetDefaultColors)
            {
                ...
                player.eyeColor = new Color(175, 175, 0);
