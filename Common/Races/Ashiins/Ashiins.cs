...
namespace RogueLineageRaces.Common.Races.Ashiins
{
	public class Ashiins : Race
	{
		...
		public override string RaceLore1 => "Ashiins are a race" + "\noriented around" + "\nbeing well-rounded" + "\nwith multiple decent" + "\nbuffs for the beginning.";
		public override string RaceLore2 => "Their tenacity for training and" + "\ntheir knowledge for combat has" + "\nhelped them to develop skills" + "\nin multiple different areas.";
		...
		public override string RaceEnvironmentOverlay2Icon => ($"RogueLineageRaces/Common/UI/RaceDisplay/Environment/RogueLineageRacesEnvironment");
