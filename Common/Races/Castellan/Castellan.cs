...
namespace RogueLineageRaces.Common.Races.Castellan
{
	public class Castellan : Race
	{
		...
		public override string RaceLore1 => "Castellans are a race" + "\noriented around" + "\nMage classes.";
		public override string RaceLore2 => "Their yearning for knowledge" + "\nhas led them to discover both the" + "\nworld of Terraria and more ways" + "\nof using Mana more efficently.";
		...
		public override string RaceEnvironmentOverlay2Icon => ($"RogueLineageRaces/Common/UI/RaceDisplay/Environment/CastellanEnvironment");
