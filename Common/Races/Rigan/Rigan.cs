...
namespace RogueLineageRaces.Common.Races.Rigan
{
	public class Rigan : Race
	{
		...
		public override string RaceLore1 => "Rigans are a race" + "\noriented around " + "\nMana regen and"  +  "\ntasks.";
		public override string RaceLore2 => "Their enhanced ability to attract" + "\nMana from the world has helped" + "\nthem to do certain tasks at" + "\ngreater speeds.";
		...
		public override string RaceEnvironmentOverlay2Icon => ($"RogueLineageRaces/Common/UI/RaceDisplay/Environment/RiganEnvironment");
		
		public override string RaceAbilityName => "Shock Tsunami";
