...
namespace RogueLineageRaces.Common.Races.Scroom
{
	public class Scroom : Race
	{
		public override string RaceSelectIcon => ($"RogueLineageRaces/Common/UI/RaceDisplay/ScroomSelectIcon");
		public override string RaceDisplayMaleIcon => ($"RogueLineageRaces/Common/UI/RaceDisplay/ScroomDisplayMale");
		public override string RaceDisplayFemaleIcon => ($"RogueLineageRaces/Common/UI/RaceDisplay/ScroomDisplayFemale");
		
		public override string RaceDisplayName => "Scrooms Of Gaia";
		public override string RaceLore1 => "Scrooms are a fungus-like race oriented around being evasive, but with a last resort!";
		public override string RaceLore2 => "Scrooms are a race who tend to" + "\nonly care about themselves. All of" + "\nthem are inherently evil from an" + "\nevil deal made by their king.";
		
		public override string RaceEnvironmentIcon => ($"RogueLineageRaces/Common/UI/RaceDisplay/Scroom");
		public override string RaceEnvironmentOverlay2Icon => ($"RogueLineageRaces/Common/UI/RaceDisplay/Environment/Multiple");
		public override string RaceEnvironmentOverlay1Icon => ($"RogueLineageRaces/Common/UI/RaceDisplay/Environment/ScroomEnvironment");
		
		public override string RaceMinionsDisplayText => "[c/34EB93:+1]";
		public override string RaceRegenerationDisplayText => "[c/34EB93:+2.5]";
		public override string RaceThornsDisplayText => "[c/34EB93:+215%]";
		public override string RaceMagicCritChanceDisplayText => "[c/34EB93:+12%]";
		public override string RaceFishingSkillDisplayText => "[c/34EB93:+10]";
		public override string RaceMeleeSpeedDisplayText => "[c/34EB93:+20%]";
		...
		public override string RaceAbilityName => "Shamble Bramble (Active) Scroomy (Passive)";
		public override string RaceAbilityDescription1 => "Heal yourself with rapid healing and gain a lot more Thorns at the complete cost of your mobility and any chance you had at Endurance.";
		public override string RaceAbilityDescription2 => "Shamble Bramble causes you to stay in place and redirect incoming melee attacks. Any attacks landed will deal massive amounts of damage";
		public override string RaceAbilityDescription3 => "to both parties. Your endurance and defense will be reduced during Shamble Bramble by a good amount.";
		public override string RaceAbilityDescription4 => "----------------------------------------------------------------------------------------------------";
        public override string RaceAbilityDescription5 => "You're immune to Ichor due to being a Scroom. You have thorns surrounding your body because of a recent mutation."; //You're immune to 'Poison' and Ichor due to being a Scroom.
		public override string RaceAbilityDescription6 => "Having your entire race be downgraded to 'grips' and 'jails' has given you a necessity for minions and hitting back hard. You've become light-weight.";
		public override string RaceAdditionalNotesDescription1 => "-A semi-glass cannon as well as somewhat sacrificing, scrooms are better off not tanking for too long, despite their high thorns potential.";
		public override string RaceAdditionalNotesDescription2 => "^*Their average health pool with almost no additives to defense besides their high-tier thorns makes them offensive redirection tanks at best.";
		public override string RaceAdditionalNotesDescription3 => "-Can redirect with even stronger attacks, even reaching damages as high as 700+ against enraged bosses, and 200+ against meteorite";
		public override string RaceAdditionalNotesDescription4 => "heads when using Shamble Bramble. They will still take a lot of damage themselves however, and this ability should be used with care.";
		public override string RaceAdditionalNotesDescription5 => "-Shamble Bramble places you in a web when used. This can be used to your advantage incase if you need to stop yourself. Note, it does not";
		public override string RaceAdditionalNotesDescription6 => "decrease or increase fall damage the longer you stay webbed. Lessened Invurnerability is in play when using Shamble Bramble." + "\nOriginally, this race was going to be 'evasive'. However it didn't seem to turn out that way.";
		...
		public override void ResetEffects(Player player)
		{
			...
			if (modPlayer.RaceStats)
			{
				...
				if (player.HasBuff(69)) // Don't drink Ichor! It's bad for your brain.. Wait.. What do you mean you don't have one?? A true Scroom?.. Oh.
				{
				...
				player.fishingSkill += 10; // Mushrooms = fishing bait maybe. Scrooms were going to be Evasive originally.
				player.buffImmune[BuffID.Poisoned] = true; // Doesn't work right now. I won't try to "fix it".
				player.buffImmune[BuffID.Ichor] = true;
	               if (player.HasBuff(160))
				  {
					...
					player.thorns += 3.3f;
					player.AddBuff(58, 2);
					player.lifeRegen += (player.statLifeMax2 / 150);
					player.runAcceleration -= 0.1f;
					player.AddBuff(149, 1);
...
public override void ModifyDrawInfo(Player player, Mod mod, ref PlayerDrawInfo drawInfo)
        {
            ...
            if (modPlayer.resetDefaultColors)
            {
                ...
                player.hairColor = new Color(196, 80, 80);
              	player.skinColor = new Color(232, 232, 230);
	            player.eyeColor = new Color(255, 255, 255);
		...
		public override void ModifyDrawLayers(Player player, List<PlayerLayer> layers)
{
	...
	Main.playerTextures[0, 0] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Head");
	Main.playerTextures[0, 1] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Eyes_2");
	Main.playerTextures[0, 2] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Eyes");
	Main.playerTextures[0, 3] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Torso");
	...
	Main.playerTextures[0, 5] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Hands");
	...
	Main.playerTextures[0, 7] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Arm");
	...
	Main.playerTextures[0, 9] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Hand");
	Main.playerTextures[0, 10] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Legs");
	...
	Main.playerTextures[1, 0] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Head");
	Main.playerTextures[1, 1] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Eyes_2");
	Main.playerTextures[1, 2] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Eyes");
	Main.playerTextures[1, 3] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Torso");
	...
	Main.playerTextures[1, 5] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Hands");
	...
	Main.playerTextures[1, 7] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Arm");
	...
	Main.playerTextures[1, 9] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Hand");
	Main.playerTextures[1, 10] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Legs");
	...
	Main.playerTextures[2, 0] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Head");
	Main.playerTextures[2, 1] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Eyes_2");
	Main.playerTextures[2, 2] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Eyes");
	Main.playerTextures[2, 3] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Torso");
	...
	Main.playerTextures[2, 5] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Hands");
	...
	Main.playerTextures[2, 7] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Arm");
	...
	Main.playerTextures[2, 9] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Hand");
	Main.playerTextures[2, 10] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Legs");
	...
	Main.playerTextures[3, 0] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Head");
	Main.playerTextures[3, 1] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Eyes_2");
	Main.playerTextures[3, 2] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Eyes");
	Main.playerTextures[3, 3] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Torso");
	...
	Main.playerTextures[3, 5] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Hands");
	...
	Main.playerTextures[3, 7] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Arm");
	...
	Main.playerTextures[3, 9] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Hand");
	Main.playerTextures[3, 10] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Legs");
	...
	Main.playerTextures[8, 0] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Head");
	Main.playerTextures[8, 1] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Eyes_2");
	Main.playerTextures[8, 2] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Eyes");
	Main.playerTextures[8, 3] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Torso");
	...
	Main.playerTextures[8, 5] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Hands");
	...
	Main.playerTextures[8, 7] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Arm");
	...
	Main.playerTextures[8, 9] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Hand");
	Main.playerTextures[8, 10] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Legs");
	...
	Main.playerTextures[4, 0] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Head_Female");
	Main.playerTextures[4, 1] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Eyes_2_Female");
	Main.playerTextures[4, 2] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Eyes_Female");
	Main.playerTextures[4, 3] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Torso_Female");
	...
	Main.playerTextures[4, 5] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Hands_Female");
	...
	Main.playerTextures[4, 7] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Arm_Female");
	...
	Main.playerTextures[4, 9] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Hand_Female");
	Main.playerTextures[4, 10] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Legs_Female");
	...
	Main.playerTextures[5, 0] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Head_Female");
	Main.playerTextures[5, 1] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Eyes_2_Female");
	Main.playerTextures[5, 2] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Eyes_Female");
	Main.playerTextures[5, 3] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Torso_Female");
	...
	Main.playerTextures[5, 5] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Hands_Female");
	...
	Main.playerTextures[5, 7] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Arm_Female");
	...
	Main.playerTextures[5, 9] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Hand_Female");
	Main.playerTextures[5, 10] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Legs_Female");
	...
	Main.playerTextures[6, 0] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Head_Female");
	Main.playerTextures[6, 1] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Eyes_2_Female");
	Main.playerTextures[6, 2] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Eyes_Female");
	Main.playerTextures[6, 3] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Torso_Female");
	...
	Main.playerTextures[6, 5] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Hands_Female");
	...
	Main.playerTextures[6, 7] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Arm_Female");
	...
	Main.playerTextures[6, 9] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Hand_Female");
	Main.playerTextures[6, 10] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Legs_Female");
	...
	Main.playerTextures[7, 0] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Head_Female");
	Main.playerTextures[7, 1] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Eyes_2_Female");
	Main.playerTextures[7, 2] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Eyes_Female");
	Main.playerTextures[7, 3] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Torso_Female");
	...
	Main.playerTextures[7, 5] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Hands_Female");
	...
	Main.playerTextures[7, 7] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Arm_Female");
	...
	Main.playerTextures[7, 9] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Hand_Female");
	Main.playerTextures[7, 10] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Legs_Female");
	...
	Main.playerTextures[9, 0] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Head_Female");
	Main.playerTextures[9, 1] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Eyes_2_Female");
	Main.playerTextures[9, 2] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Eyes_Female");
	Main.playerTextures[9, 3] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Torso_Female");
	...
	Main.playerTextures[9, 5] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Hands_Female");
	...
	Main.playerTextures[9, 7] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Arm_Female");
	...
	Main.playerTextures[9, 9] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Hand_Female");
	Main.playerTextures[9, 10] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Legs_Female");
	...
	Main.ghostTexture = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Scroom/Scroom_Ghost");
	
	     for (int i = 0; i < 51; i++)
			{
				Main.playerHairTexture[i] = ModContent.GetTexture($"RogueLineageRaces/Content/RaceTextures/Scroom/Hair/Scroom_Hair_1");
			}
}
	}
}