...
namespace RogueLineageRaces.Common.Races.Gaian
{
	public class Gaian : Race
	{
		...
		public override string RaceAdditionalNotesDescription2 => "-Ichor can either have a lacking effect on you or a heavy one depending on how far you are into the game due to your -60 defense.";
