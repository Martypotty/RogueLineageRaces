...
namespace RogueLineageRaces.Common.Races.Construct
{
	public class Construct : Race
	{
		...
		public override string RaceAdditionalNotesDescription1 => "-Always buffed with Warmth. Ironically encouraged to be on potion cooldown.";
		public override string RaceAdditionalNotesDescription2 => "-Activating Galvanize manually activates a weaker form of Galvanize with less of a cooldown."; 
	    public override string RaceAdditionalNotesDescription3 => "-4-5 Misc buffs are (in/ex)cluded in the list. What this means is that something like Tipsy [a Non-potion that gives effects] is included, while";
		public override string RaceAdditionalNotesDescription4 => "Titan potion isn't. [A potion that should effect your knockback stats but isn't included in the Baneful passive.]";
