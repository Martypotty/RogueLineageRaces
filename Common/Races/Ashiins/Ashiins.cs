...
namespace RogueLineageRaces.Common.Races.Ashiins
{
	public class Ashiins : Race
	{
		public override string RaceSelectIcon => ($"RogueLineageRaces/Common/UI/RaceDisplay/AshiinsSelectIcon");
		public override string RaceDisplayMaleIcon => ($"RogueLineageRaces/Common/UI/RaceDisplay/AshiinsDisplayMale");
		public override string RaceDisplayFemaleIcon => ($"RogueLineageRaces/Common/UI/RaceDisplay/AshiinsDisplayFemale");
		
		public override string RaceDisplayName => "Ashiins Of Gaia";
		public override string RaceLore1 => "Ashiins are a race oriented around being well-rounded with multiple decent buffs.";
		public override string RaceLore2 => "Their tenacity for training and their knowledge for combat has helped them to develop skills in multiple different areas.";
		
		public override string RaceEnvironmentIcon => ($"RogueLineageRaces/Common/UI/RaceDisplay/Ashiins");
		public override string RaceEnvironmentOverlay2Icon => ($"RogueLineageRaces/Common/UI/RaceDisplay/Environment/Multiple");
		public override string RaceEnvironmentOverlay1Icon => ($"RogueLineageRaces/Common/UI/RaceDisplay/Environment/RogueLineageRacesEnvironment");
		
				public override string RaceAbilityName => "Fighting Strategy (Passive)";
		public override string RaceAbilityDescription1 => "Being inflicted with certain debuffs will grant you a buff.";
		public override string RaceAbilityDescription2 => "It's not random. The buff depends on the debuff. Not every debuff is included, however a multitude of them are.";
		public override string RaceHealthDisplayText => "[c/34EB93:+10%]";
		public override string RaceManaDisplayText => "[c/34EB93:+10%]";
		public override string RaceRegenerationDisplayText => "[c/34EB93:+1]";
		public override string RaceManaRegenerationDisplayText => "[c/34EB93:+8]";
		public override string RaceMeleeDamageDisplayText => "[c/34EB93:+8%]";
		public override string RaceMeleeSpeedDisplayText => "[c/34EB93:+8%]";
		public override string RaceFishingSkillDisplayText => "[c/34EB93:+4.5]";
		public override string RaceRangedDamageDisplayText => "[c/34EB93:+12.5%]";
		public override string RaceArmorPenetrationDisplayText => "[c/34EB93:+3]";
		public override string RaceMiningSpeedDisplayText => "[c/34EB93:-12.5%]";
		public override string RaceManaCostDisplayText => "[c/34EB93:-4%]";
		public override string RaceAdditionalNotesDescription1 => "-Unironically lacks a decent direct buff for one of the classes.";
		public override string RaceAdditionalNotesDescription2 => "-Full of surprises.";
		...
		public override void ResetEffects(Player player)
		{
			...
			{
				player.AddBuff(105, 3);
				player.AddBuff(106, 3);
				player.AddBuff(111, 3);
			}
							if (player.HasBuff(144))
			{
				player.AddBuff(114, 3);
				player.AddBuff(17, 2);
			}
				if (player.HasBuff(169))
			{
				player.AddBuff(312, 3);
			}
				if (player.HasBuff(38))
			{
				player.AddBuff(59, 3);
			}
			...
			if (player.HasBuff(145))
			{
				...
				if (player.HasBuff(153))
			{
				player.AddBuff(10, 3);
			}
						if (player.HasBuff(156))
			{
				player.AddBuff(8, 3);
			}
								if (player.HasBuff(46))
			{
				player.AddBuff(3, 3);
			}
										if (player.HasBuff(68))
			{
				player.AddBuff(18, 30);
			}
													if (player.HasBuff(39))
			{
				player.AddBuff(116, 160);
			}
																if (player.HasBuff(69))
			{
				player.AddBuff(14, 3);
			}
...
public override void ModifyDrawInfo(Player player, Mod mod, ref PlayerDrawInfo drawInfo)
        {
            ...
            if (modPlayer.resetDefaultColors)
            {
                ...
                player.hairColor = new Color(197, 0, 0);
              	player.skinColor = new Color(250, 163, 28);
	            player.eyeColor = new Color(0, 153, 28);
		...
		public override void ModifyDrawLayers(Player player, List<PlayerLayer> layers)
{
	...
	Main.playerTextures[0, 0] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Head");
	Main.playerTextures[0, 1] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Eyes_2");
	Main.playerTextures[0, 2] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Eyes");
	Main.playerTextures[0, 3] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Torso");
	...
	Main.playerTextures[0, 5] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Hands");
	...
	Main.playerTextures[0, 7] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Arm");
	...
	Main.playerTextures[0, 9] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Hand");
	Main.playerTextures[0, 10] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Legs");
	...
	Main.playerTextures[1, 0] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Head");
	Main.playerTextures[1, 1] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Eyes_2");
	Main.playerTextures[1, 2] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Eyes");
	Main.playerTextures[1, 3] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Torso");
	...
	Main.playerTextures[1, 5] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Hands");
	...
	Main.playerTextures[1, 7] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Arm");
	...
	Main.playerTextures[1, 9] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Hand");
	Main.playerTextures[1, 10] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Legs");
	...
	Main.playerTextures[2, 0] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Head");
	Main.playerTextures[2, 1] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Eyes_2");
	Main.playerTextures[2, 2] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Eyes");
	Main.playerTextures[2, 3] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Torso");
	...
	Main.playerTextures[2, 5] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Hands");
	...
	Main.playerTextures[2, 7] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Arm");
	...
	Main.playerTextures[2, 9] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Hand");
	Main.playerTextures[2, 10] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Legs");
	...
	Main.playerTextures[3, 0] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Head");
	Main.playerTextures[3, 1] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Eyes_2");
	Main.playerTextures[3, 2] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Eyes");
	Main.playerTextures[3, 3] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Torso");
	...
	Main.playerTextures[3, 5] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Hands");
	...
	Main.playerTextures[3, 7] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Arm");
	...
	Main.playerTextures[3, 9] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Hand");
	Main.playerTextures[3, 10] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Legs");
	...
	Main.playerTextures[8, 0] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Head");
	Main.playerTextures[8, 1] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Eyes_2");
	Main.playerTextures[8, 2] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Eyes");
	Main.playerTextures[8, 3] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Torso");
	...
	Main.playerTextures[8, 5] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Hands");
	...
	Main.playerTextures[8, 7] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Arm");
	...
	Main.playerTextures[8, 9] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Hand");
	Main.playerTextures[8, 10] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Legs");
	...
	Main.playerTextures[4, 0] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Head_Female");
	Main.playerTextures[4, 1] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Eyes_2_Female");
	Main.playerTextures[4, 2] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Eyes_Female");
	Main.playerTextures[4, 3] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Torso_Female");
	...
	Main.playerTextures[4, 5] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Hands_Female");
	...
	Main.playerTextures[4, 7] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Arm_Female");
	...
	Main.playerTextures[4, 9] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Hand_Female");
	Main.playerTextures[4, 10] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Legs_Female");
	...
	Main.playerTextures[5, 0] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Head_Female");
	Main.playerTextures[5, 1] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Eyes_2_Female");
	Main.playerTextures[5, 2] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Eyes_Female");
	Main.playerTextures[5, 3] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Torso_Female");
	...
	Main.playerTextures[5, 5] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Hands_Female");
	...
	Main.playerTextures[5, 7] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Arm_Female");
	...
	Main.playerTextures[5, 9] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Hand_Female");
	Main.playerTextures[5, 10] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Legs_Female");
	...
	Main.playerTextures[6, 0] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Head_Female");
	Main.playerTextures[6, 1] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Eyes_2_Female");
	Main.playerTextures[6, 2] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Eyes_Female");
	Main.playerTextures[6, 3] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Torso_Female");
	...
	Main.playerTextures[6, 5] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Hands_Female");
	...
	Main.playerTextures[6, 7] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Arm_Female");
	...
	Main.playerTextures[6, 9] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Hand_Female");
	Main.playerTextures[6, 10] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Legs_Female");
	...
	Main.playerTextures[7, 0] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Head_Female");
	Main.playerTextures[7, 1] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Eyes_2_Female");
	Main.playerTextures[7, 2] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Eyes_Female");
	Main.playerTextures[7, 3] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Torso_Female");
	...
	Main.playerTextures[7, 5] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Hands_Female");
	...
	Main.playerTextures[7, 7] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Arm_Female");
	...
	Main.playerTextures[7, 9] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Hand_Female");
	Main.playerTextures[7, 10] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Legs_Female");
	...
	Main.playerTextures[9, 0] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Head_Female");
	Main.playerTextures[9, 1] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Eyes_2_Female");
	Main.playerTextures[9, 2] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Eyes_Female");
	Main.playerTextures[9, 3] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Torso_Female");
	...
	Main.playerTextures[9, 5] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Hands_Female");
	...
	Main.playerTextures[9, 7] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Arm_Female");
	...
	Main.playerTextures[9, 9] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Hand_Female");
	Main.playerTextures[9, 10] = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Legs_Female");
	...
	for (int i = 0; i < 51; i++)
			{
				Main.playerHairTexture[i] = ModContent.GetTexture($"RogueLineageRaces/Content/RaceTextures/Ashiins/Hair/Human_Hair_{i + 1}");
			}

	Main.ghostTexture = ModContent.GetTexture("RogueLineageRaces/Content/RaceTextures/Ashiins/Ashiins_Ghost");
}
