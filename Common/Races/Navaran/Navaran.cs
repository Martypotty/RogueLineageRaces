...
namespace RogueLineageRaces.Common.Races.Navaran
{
	public class Navaran : Race
	{
		...
		public override string RaceLore1 => "Navarans are a race oriented around utilizing an outside source to change their build.";
		public override string RaceLore2 => "An alien entity split into fragments, not much is known about It besides It's copying from & brutal battling with others.";
		...
		public override string RaceAbilityName => "Advanced Emulate (Active, grants unique passives.)";
