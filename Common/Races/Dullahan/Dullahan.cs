...
namespace RogueLineageRaces.Common.Races.Dullahan
{
	public class Dullahan : Race
	{
	    ...
	    public override string RaceAbilityDescription1 => "You have 1.6+ regen by default, and have an additional amount of regen based on your max health.";
		...
		public override string RaceAdditionalNotesDescription2 => "-Permanent Shine effect. Always Well Fed. Starts with 3HP regen total.";
		...
		public override string RaceAdditionalNotesDescription4 => "-Their health regen is almost always active when it is not inhibited by a Debuff, and with a life force potion could reach 10 HP regen.";
		public override string RaceAdditionalNotesDescription5 => "\n" + "New note for the future; I don't know if I'll ever add an attack ability to this. But even if I do, it'll likely be weak enough to not";
		public override string RaceAdditionalNotesDescription6 => "warrant a heavy nerf of some sort. Health regen in this mod is already their main ability and I intend on keeping it as such.";

		public override string RaceRegenerationDisplayText => "[c/DCD0FF:1.6+%]";
		public override void ResetEffects(Player player)
		{
			var modPlayer = player.GetModPlayer<MrPlagueRaces.MrPlagueRacesPlayer>();
			if (modPlayer.RaceStats)
			{
				player.lifeRegen += 6 / 4;
				player.lifeRegen += 10 / 100;
				...
				//if (nightTime) // not sure how to make this work. At the moment this doesn't seem to function except in the sense that it's always on. :X
				//{	
			    // player.lifeRegen += 0;
                //}
