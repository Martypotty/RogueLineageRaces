...
namespace RogueLineageRaces.Common.Races.Dzin
{
	public class Dzin : Race
	{
		...
		public override string RaceAbilityName => "Worlds Pulse (Active, Passive) Awakening (Active Alt)";
	    ...
	    public override string RaceRangedDamageDisplayText => "[c/34EB93:+15%]";
		...
		public override string RaceAdditionalNotesDescription1 => "-Striking Moment grants an additional 4 armor pierce while active.";
		public override string RaceAdditionalNotesDescription2 => "-Striking Moment will also grant an additional 75% melee damage boost [Which will then be multiplied with Striking Moment's 4x.. Yup!].";
