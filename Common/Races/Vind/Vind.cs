...
namespace RogueLineageRaces.Common.Races.Vind
{
	public class Vind : Race
	{
		...
		public override string RaceLore1 => "Vinds are a race" + "\noriented around mages and inhibiting someone's battle plan constantly.";
		...
		public override string RaceAbilityDescription2 => "The Health Nebula lasts for 2.1 seconds before swapping. The Mana Nebulas last for 2.9 seconds.";
		...
		public override string RaceAbilityDescription5 => "Both swaps have thorns and movement, however they have over 2x the shared amount during their respective turns. ";
		...
		public override string RaceAdditionalNotesDescription4 => "Contrary to popular belief, Vinds do not have mana regen in rogue.. Don't ask why I gave Fischerans/Morvids it. They don't either.";
		...
		public override string RaceAdditionalNotesDescription2 => "-The total time Tempest twist is active for is roughly 5 seconds. The cooldown is 13.5 seconds long.";
		public override void ResetEffects(Player player)
		{
			...
			{	
				...
				if (player.HasBuff(186))
				{
				  ...
				  player.thorns += 0.75f;
				  player.runAcceleration += 0.0145f;
				    //
				    if (player.HasBuff(204))
					{
						player.AddBuff(203, 175);
						player.AddBuff(173, 1);
						player.thorns += 1.25f;
						player.AddBuff(170, 1);
						player.endurance += 1f;
						player.AddBuff(88, 811);
					...
					else if (player.HasBuff(203))
					{
						...
						player.runAcceleration += 0.0175f;
						player.AddBuff(88, 811); // Every 60 is a second.
					}
			...
			public override void ProcessTriggers(Player player, Mod mod)
		{
			...
			if (modPlayer.RaceStats)
			{
                ...
                {
					player.AddBuff(186, 302);
					player.AddBuff(137, 4);
					player.AddBuff(204, 128);
