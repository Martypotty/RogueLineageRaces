...
namespace RogueLineageRaces.Common.Races.Haseldan
{
	public class Haseldan : Race
	{
		...
		public override string RaceLore1 => "Haseldans are a race" + "\noriented around" + "\nrisking it/making a" + "\ngreat come back.";
		public override string RaceLore2 => "Their stubbornness and" + "\nstrong will to live has helped" + "\nthem keep their focus" + "\nand withstand more pain.";
		...
		public override string RaceEnvironmentOverlay2Icon => ($"RogueLineageRaces/Common/UI/RaceDisplay/Environment/HaseldanEnvironment");
		...
		public override string RaceAbilityDescription3 => "When you exit Final Stand via reaching 5% health, you will temporarily lose a great amount of endurance.";
		...
		public override string RaceAdditionalNotesDescription1 => "-Takes no knockback unless they enter a deep recovery from Final Stand.";
		public override string RaceAdditionalNotesDescription2 => "-It's damage bonus applies to everything.";
		public override string RaceAdditionalNotesDescription3 => "-Life draining effects struggle to finish you.";
