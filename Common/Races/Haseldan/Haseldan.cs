...
namespace RogueLineageRaces.Common.Races.Haseldan
{
	public class Haseldan : Race
	{
		...
		public override string RaceAdditionalNotesDescription2 => "-It's damage bonus applies to everything. Summons, magic, grenades, modded. Any damage type should work.";
