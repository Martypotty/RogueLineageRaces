...
namespace RogueLineageRaces.Common.Races.Dinakeri
{
	public class Dinakeri : Race
	{
		...
		public override string RaceAggroDisplayText => "[c/34EB93:-65]";
		...
		public override string RaceAdditionalNotesDescription4 => "However, the lessened Health regeneration from buffs is always active, and you gain 'aggro' equivilant to your passive while in the state.";
